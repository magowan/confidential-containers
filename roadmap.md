...
- The **short-term roadmap** is focused on achieving an end-to-end, easy to deploy and stable confidential containers solution. We track this work on a number of github boards (detailed later on)
- The **mid/long-term solutions** focuses on use case driven development (detailed later on)
...
# Mid-Term Roadmap/ Long-Term Roadmap
